											...
											<li class="relative">
												<div class="max-h-[288px] overflow-y-auto relative notification-scroll">
													<div class="relative flex px-4 py-4 cursor-pointer hover:bg-gray-50 active:bg-gray-100 dark:hover:bg-black dark:hover:bg-opacity-20  border-b border-gray-200 dark:border-gray-600">
														<div>
															<span class="avatar avatar-circle avatar-md">
																<img class="avatar-img avatar-circle" src="images/thumb-8.jpg" loading="lazy" alt="">
															</span>
														</div>
													...
													<div class="relative flex px-4 py-4 cursor-pointer hover:bg-gray-50 active:bg-gray-100 dark:hover:bg-black dark:hover:bg-opacity-20  border-b border-gray-200 dark:border-gray-600">
														<div>
															<span class="avatar avatar-circle avatar-md">
																<img class="avatar-img avatar-circle" src="images/thumb-4.jpg" loading="lazy" alt="">
															</span>
														</div>
														<div class="ltr:ml-3 rtl:mr-3">
															<div>
									...
									<div class="dropdown">
										<div class="dropdown-toggle" id="user-dropdown" data-bs-toggle="dropdown">
											<div class="header-action-item flex items-center gap-2">
												...
												<img class="avatar-img avatar-circle" src="images/thumb-1.jpg" loading="lazy" alt=""></span>
										...
										<ul class="dropdown-menu bottom-end min-w-[240px]">
											<li class="menu-item-header">
												<div class="py-2 px-3 flex items-center gap-2">
													<span class="avatar avatar-circle avatar-md">
														<img class="avatar-img avatar-circle" src="images/thumb-1.jpg" loading="lazy" alt="">
													</span>
													<div>
														...
														<div class="grid grid-cols-3 gap-4 w-full">
															<div class="text-center" id="layout-classic">
																<div class="flex items-center border rounded-md border-gray-200 dark:border-gray-600 cursor-pointer select-none w-100 hover:ring-1 hover:ring-primary-600 hover:border-primary-600 relative min-h-[80px] w-full">
																	<img src="images/classic.jpg" alt="" class="rounded-md dark:hidden">
																	<img src="images/classic-dark.jpg" alt="" class="rounded-md hidden dark:block">
																</div>
															...
															<div class="text-center" id="layout-modern">
																<div class="flex items-center border rounded-md dark:border-gray-600 cursor-pointer select-none w-100 ring-1 ring-primary-600 border-primary-600 hover:ring-1 hover:ring-primary-600 hover:border-primary-600 relative min-h-[80px] w-full">
																	<img src="images/modern.jpg" alt="" class="rounded-md dark:hidden">
																	<img src="images/modern-dark.jpg" alt="" class="rounded-md hidden dark:block">
															...
															<div class="text-center" id="layout-stackedSide">
																<div class="flex items-center border rounded-md border-gray-200 dark:border-gray-600 cursor-pointer select-none w-100 hover:ring-1 hover:ring-primary-600 hover:border-primary-600 relative min-h-[80px] w-full">
																	<img src="images/stackedSide.jpg" alt="" class="rounded-md dark:hidden">
																	<img src="images/stackedSide-dark.jpg" alt="" class="rounded-md hidden dark:block">
																</div>
																<div class="mt-2 font-semibold">Stacked Side</div>
															</div>
															<div class="text-center" id="layout-simple">
																<div class="flex items-center border rounded-md border-gray-200 dark:border-gray-600 cursor-pointer select-none w-100 hover:ring-1 hover:ring-primary-600 hover:border-primary-600 relative min-h-[80px] w-full">
																	<img src="images/simple.jpg" alt="" class="rounded-md dark:hidden">
																	<img src="images/simple-dark.jpg" alt="" class="rounded-md hidden dark:block">
																</div>
																<div class="mt-2 font-semibold">Simple</div>
															</div>
															<div class="text-center" id="layout-decked">
																<div class="flex items-center border rounded-md border-gray-200 dark:border-gray-600 cursor-pointer select-none w-100 hover:ring-1 hover:ring-primary-600 hover:border-primary-600 relative min-h-[80px] w-full">
																	<img src="images/decked.jpg" alt="" class="rounded-md dark:hidden">
																	<img src="images/decked-dark.jpg" alt="" class="rounded-md hidden dark:block">
																</div>
                                                        ...
                                                        <div class="flex flex-col justify-center px-4">
                                                            <div class="mb-6 flex justify-between">
                                                                <div class="flex items-center gap-2">
                                                                    ...
                                                                    <div class="font-semibold">United States of America</div>
                                                                </div>
                                                                <div>37.61%</div>
                                                            </div>
                                                            <div class="mb-6 flex justify-between">
                                                        ...
                                                        <div class="progress flex justify-center circle">
                                                            <div class="progress-circle" style="width: 200px;">
                                                                ...
                                                                <svg viewBox="0 0 100 100">
                                                                    <path d="M 50,50 m 0,-48 a 48,48 0 1 1 0,96 a 48,48 0 1 1 0,-96" stroke-width="4" fill-opacity="0" class="progress-circle-trail" style="stroke-dasharray: 301.593px, 301.593px; stroke-dashoffset: 0px;"></path>
                                                                    <path d="M 50,50 m 0,-48 a 48,48 0 1 1 0,96 a 48,48 0 1 1 0,-96" stroke-linecap="round" stroke-width="4" fill-opacity="0" class="progress-circle-stroke text-indigo-600" style="stroke-dasharray: 220.163px, 301.593px; stroke-dashoffset: 0px;"></path>
                                                                </svg>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <table class="table-default table-hover">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <div class="flex items-center gap-2">
                                                                        <span class="avatar avatar-circle avatar-sm" data-avatar-size="25">
                                                                            <img class="avatar-img avatar-circle" src="images/thumb-1.jpg" loading="lazy">
                                                                        </span>
                                                                ...
                                                                <td>
                                                                    <div class="tag rounded-md font-bold cursor-pointer select-none text-gray-900 dark:text-gray-100">
                                                                        Carrie Harris
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <div class="flex items-center gap-2">
                                                                        <span class="avatar avatar-circle avatar-sm" data-avatar-size="25">
                                                                            <img class="avatar-img avatar-circle" src="images/thumb-2.jpg" loading="lazy">
                                                                        </span>
                                                                        <span class="font-semibold">Terrance Moreno</span>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="tag bg-emerald-100 text-emerald-600 dark:bg-emerald-500/20 dark:text-emerald-100 border-0 rounded">Sold</div>
                                                                </td>
                                                                <td>terrance_moreno@infotech.io</td>
                                                                <td><span>23/09/2021 06:40</span></td>
                                                                <td>
                                                                    <div class="tag rounded-md font-bold cursor-pointer select-none text-gray-900 dark:text-gray-100">Toni Lane</div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <div class="flex items-center gap-2">
                                                                        <span class="avatar avatar-circle avatar-sm" data-avatar-size="25">
                                                                            <img class="avatar-img avatar-circle" src="images/thumb-3.jpg" loading="lazy">
                                                                        </span>
                                                                ...
                                                                <td><span>23/09/2021 06:40</span></td>
                                                                <td>
                                                                    <div class="tag rounded-md font-bold cursor-pointer select-none text-gray-900 dark:text-gray-100">Joanne Mendoza</div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <div class="flex items-center gap-2">
                                                                        <span class="avatar avatar-circle avatar-sm" data-avatar-size="25">
                                                                            <img class="avatar-img avatar-circle" src="images/thumb-4.jpg" loading="lazy">
                                                                        </span>
                                                                        <span class="font-semibold">Luke Cook</span>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="tag text-amber-600 bg-amber-100 dark:text-amber-100 dark:bg-amber-500/20 border-0 rounded">Not Interested</div>
                                                                </td>
                                                                <td>cookie_lukie@hotmail.com</td>
                                                                <td><span>28/09/2021 12:53</span></td>
                                                                <td>
                                                                    <div class="tag rounded-md font-bold cursor-pointer select-none text-gray-900 dark:text-gray-100">Lorraine Carr</div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <div class="flex items-center gap-2">
                                                                        <span class="avatar avatar-circle avatar-sm" data-avatar-size="25">
                                                                            <img class="avatar-img avatar-circle" src="images/thumb-5.jpg" loading="lazy">
                                                                        </span>
                                                                        <span class="font-semibold">Joyce Freeman</span>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="tag bg-blue-100 text-blue-600 dark:bg-blue-500/20 dark:text-blue-100 border-0 rounded">In Progress</div>
                                                                </td>
                                                                <td>joyce991@infotech.io</td>
                                                                <td><span>24/09/2021 12:53</span></td>
                                                                <td>
                                                                    <div class="tag rounded-md font-bold cursor-pointer select-none text-gray-900 dark:text-gray-100">Myrtle Mason</div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <div class="flex items-center gap-2">
                                                                        <span class="avatar avatar-circle avatar-sm" data-avatar-size="25">
                                                                            <img class="avatar-img avatar-circle" src="images/thumb-6.jpg" loading="lazy">
                                                                        </span>
                                                                        <span class="font-semibold">Samantha Phillips</span>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="tag rounded-md">New</div>
                                                                ...
                                                                <td>
                                                                    <div class="tag rounded-md font-bold cursor-pointer select-none text-gray-900 dark:text-gray-100">Perry Ward</div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
